const store = [
    {
        ...
        'In addition, the deep-fried yuba rolled vegetables cutlet set has a delightful and refreshing taste that should be popular among women.',
    ...
    },
    {
        ...
        intro: "Traditional snack shop famous for 'Ubatama', features red bean paste wrapped in Okinawan black sugar skin.",
    ...
    },
    {
        ...
        mobile_intro:'「いづ重」位於衹園八阪神社，以傳承百年的鯖姿壽司及大阪地區的壓壽司聞名。' +
